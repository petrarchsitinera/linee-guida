...
> <img width="1298" alt="Schermata 2023-02-04 alle 16 24 10" src="https://user-images.githubusercontent.com/102725489/216775478-c4fc6a46-e867-4716-b06a-b2214b73de2b.png">

Per creare una nuova _part_, selezionare la _part_ desiderata dal menu a tendina e cliccare sul comando _+ add part_. Il comando di aggiunta si illuminerà soltanto a selezione avvenuta.  

> <img width="302" alt="Schermata 2023-02-04 alle 16 25 52" src="https://user-images.githubusercontent.com/102725489/216775588-eaaa58be-1d64-48a4-afb6-2e7361c79174.png">


Per modificare una _part_ all'interno di un _item_, cliccare sul comando _edit_ accanto alla _part_ da modificare e procedere con le modifiche (1).    
Per eliminare una _part_ all'interno di un _item_, cliccare sul comando  _delete_ accanto alla parte da eliminare (2), e confermare cliccando _yes_ nella finestra pop-up.
> <img width="278" alt="Schermata 2023-02-04 alle 16 28 24" src="https://user-images.githubusercontent.com/102725489/216775867-c2812cef-5de8-41e2-93f6-201f22b09e5c.png">
...
Alcune _parts_ sono costituite da elementi replicabili, che vanno aggiunti singolarmente. Per creare un elemento all'interno di una _part_, cliccare sul comando _+ [nome dell'elemento]_.

Per aggiungere, modificare, eliminare elementi, accedere alla schermata di riepilogo degli elementi della _part_.  
...
Per modificare un elemento, cliccare sul comando _edit_ accanto all'elemento da modificare e procedere con le modifiche (1).    
Per modificare l'ordine degli elementi, cliccare sui comandi _move up_ e _move down_ (2).  
Per eliminare un elemento, cliccare sul comando _delete_, e confermare cliccando _yes_ nella finestra pop-up (3).  

> <img width="340" alt="Schermata 2023-02-04 alle 16 49 34" src="https://user-images.githubusercontent.com/102725489/216776954-43393764-ea02-4c8c-b495-0d575e636ccd.png">
...
Per annullare le modifiche apportate ad un elemento, cliccare il comando _discard changes_ in fondo alla schermata.  
...
Per salvare un _element_ e i relativi dati, cliccare sulla spunta blu in fondo al riquadro dell'_element_.  
