...
⚠️ Qualora si voglia aggiungere o precisare dati o notizie intorno ad testo inserito nella _Person work part_ e per il quale, dunque, non sia prevista la creazione di un _item_ dedicato, d'accordo con i responsabili scientifici è possibile procedere alla creazione di un _item_ dedicato, premurandosi di cancellare dl'elemento _work_ corrispondente dall'_item person_ e di aggiungere EID e titolo del testo al [repository dei corpora](repository.md) tramite segnalazione su clickup.
